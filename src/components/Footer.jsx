  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY}} flex-col`}>
            ...
            <div key={link.title} className="flex flex-col ss:my-0 my-4 min-w-[150px]">
              ...
              <ul className="list-none mt-4">
                {link.links.map((item, index) => 
                  <li key={item.name} className={`font-poppins font-normal text-[16px]
      ...
      flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        <p className="font-poppins font-normal text-center text-[14px] leading-[27px] text-white">2022 HooBank. All Rights Reserved. Created by Bilendm.</p>
